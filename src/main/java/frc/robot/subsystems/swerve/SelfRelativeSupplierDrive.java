...
/**
 * A command that drives the robot using the swerve drive in self-relative mode.
 */
public class SelfRelativeSupplierDrive extends CommandBase {
    ...
    /**
     * Constructs a new SelfRelativeSupplierDrive command.
     *
     ...
     */
    public SelfRelativeSupplierDrive(DoubleSupplier xPower, DoubleSupplier yPower, DoubleSupplier rotPower) {
        this.xPower = xPower;
        this.yPower = yPower;
